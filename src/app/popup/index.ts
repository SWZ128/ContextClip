...
app.innerHTML = `
  <main class="shell">
    <header class="hero panel">
      ...
      <a
        class="hero-link"
        href="https://github.com/WingEdge777/ContextClip"
        target="_blank"
        rel="noreferrer"
        aria-label="Open GitHub repository"
      >
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path d="M12 2C6.477 2 2 6.595 2 12.262c0 4.534 2.865 8.38 6.839 9.737.5.096.682-.221.682-.49 0-.242-.008-.883-.013-1.733-2.782.618-3.37-1.38-3.37-1.38-.454-1.183-1.11-1.498-1.11-1.498-.908-.636.069-.623.069-.623 1.004.072 1.532 1.057 1.532 1.057.892 1.567 2.341 1.115 2.91.853.091-.665.349-1.115.635-1.371-2.221-.259-4.555-1.14-4.555-5.074 0-1.121.39-2.038 1.03-2.757-.104-.26-.447-1.305.098-2.72 0 0 .84-.277 2.75 1.053A9.303 9.303 0 0 1 12 6.84a9.28 9.28 0 0 1 2.504.348c1.909-1.33 2.748-1.053 2.748-1.053.547 1.415.203 2.46.1 2.72.64.719 1.028 1.636 1.028 2.757 0 3.944-2.337 4.812-4.566 5.067.359.32.678.95.678 1.915 0 1.382-.012 2.497-.012 2.836 0 .271.18.59.688.49C19.138 20.639 22 16.794 22 12.262 22 6.595 17.523 2 12 2Z"></path>
        </svg>
        <span>GitHub</span>
      </a>
    </header>
